...
Status: **IMPLEMENTED REALITY**. A8.1 and A8.2a–A8.2e2 source and verification are recorded in [their validation records](../validation/v0.1.3-a8.1-journal-contract.md), [A8.2a](../validation/v0.1.3-a8.2a-journal-store.md), [A8.2b](../validation/v0.1.3-a8.2b-conversational-ingress.md), [A8.2c](../validation/v0.1.3-a8.2c-speech-ingress.md), [A8.2d](../validation/v0.1.3-a8.2d-vision-ingress.md), [A8.2e1](../validation/v0.1.3-a8.2e1-product-controls.md) and [A8.2e2](../validation/v0.1.3-a8.2e2-runtime-controls.md). This is the only Future document that states what exists today. Every other Future document states decisions, planned engineering or hypotheses and must defer to this record and to source. When source changes, the atom that changes it updates this file.
